Stripped-down [Gang Garrison 2](https://github.com/Medo42/Gang-Garrison-2) with only the updater, used for the "gg2update.exe" file to ensure legacy versions can still update.
----------------------------------------------------------
